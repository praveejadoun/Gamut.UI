app.controller('HomeController', function ($scope, $location, toaster , $filter, $window, $rootScope,$filter, userService,GeneralService,InspectionService,ShareData,blockUI) {
